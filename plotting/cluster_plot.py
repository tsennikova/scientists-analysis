...
data_for_plotting  = os.path.join(clustered_baseline, 'data_for_plotting')
...
#plt.show()
plt.savefig(plots_dir+'\\'+'clusters_google_trends_baseline.pdf')